    ...
    return (
        <>
            <Mission>
                ...
                top US hotel company as a React/Java dev. I value well planned, clean, and scalable code written with
                modern tooling. If my skillset fits your next project, get in touch for a free proposal.
            </Mission>
            <Skills title="Skills" />
        </>
    );
